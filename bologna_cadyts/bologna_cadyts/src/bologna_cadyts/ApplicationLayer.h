...
#include "bologna_cadyts/bologna_cadyts.h"

#include "veins/modules/application/ieee80211p/DemoBaseApplLayer.h"

namespace bologna_cadyts {
...
class BOLOGNA_CADYTS_API ApplicationLayer : public veins::DemoBaseApplLayer {
public:
    void initialize(int stage) override;

private:
    simtime_t lastSentMessage;
    simtime_t lastUpdatedInformation;
    float alpha;
